...
DATE_OVERRIDES = {
    ...
    # 2026-09-13 补充（多源核实：央广网/新华财经/JEC 3源确认2月CPI于3/11发布；
    # 金融时报+智汇研Wind确认7月金融数据于8/14发布）：
    ("US_CPI", "2026-03"): "2026-03-11",
    ("US_CORE_CPI", "2026-03"): "2026-03-11",
    ("CN_M2", "2026-08"): "2026-08-14",
    ("CN_SOCIAL_FINANCING", "2026-08"): "2026-08-14",
    ("CN_NEW_LOANS", "2026-08"): "2026-08-14",
    # 2026-09-17 补充（ONS 官方 16 September 2026 发布 8 月 CPI，中新社伦敦9/16电+ONS官网 2 源）：
